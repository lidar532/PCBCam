...
while True:
    ...
    # --- Draw all stored markers directly onto the frame ---
    for marker_pos in markers:
        # Convert stored original coordinates to the rotated frame's coordinates for drawing
    ...
    # --- Apply Pan and Zoom for Display ---
    view_w = int(frame_width / zoom_level); view_h = int(frame_height / zoom_level)
